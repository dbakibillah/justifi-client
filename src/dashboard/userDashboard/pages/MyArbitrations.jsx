...
const MyArbitrations = () => {
    ...
    const filteredArbitrations = userArbitrations
        ...
        .sort((a, b) => {
            switch (currentSort) {
                ...
                case 'value':
                    return parseFloat(b.suitValue?.replace(/[^\d.]/g, '') || 0) - parseFloat(a.suitValue?.replace(/[^\d.]/g, '') || 0);
                case 'title':
    ...
    const ongoingCount = userArbitrations.filter(a => a.arbitration_status === 'Ongoing').length;
    const plaintiffCount = userArbitrations.filter(arbitration => 
        getUserRole(arbitration, currentUser?.email) === 'Plaintiff'
    ).length;
    const defendantCount = userArbitrations.filter(arbitration => 
            ...
            <div className="container mx-auto px-4 max-w-7xl">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-600 text-lg max-w-2xl mx-auto leading-relaxed">
                        Manage and track all your arbitration cases with comprehensive overview and insights
                    </p>
                </div>
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-200/60 p-6 mb-8">
                    <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {[
                                { key: "all", label: "All Cases", color: "gray", icon: <FaCalendarCheck /> },
                                { key: "Pending", label: "Pending", color: "yellow", icon: <FaRegClock /> },
                                { key: "Ongoing", label: "Ongoing", color: "blue", icon: <FaSpinner /> },
                                { key: "Completed", label: "Completed", color: "green", icon: <FaCheckCircle /> },
                                { key: "Cancelled", label: "Cancelled", color: "red", icon: <FaTimesCircle /> },
                    ...
                    <div className="mt-6 pt-6 border-t border-gray-200/60">
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                            ...
                            <div className="text-sm text-gray-500">
                                Showing {filteredArbitrations.length} of {userArbitrations.length} cases
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                >
                                    <div className="p-6">
                                        <div className="flex justify-between items-start mb-4">
                                            <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${statusColor} gap-1`}>
                                                {statusIcon}
                                                {statusText}
                                            </span>
                                        ...
                                        <div className="space-y-3 mb-4">
                                            ...
                                            <div className="flex items-center justify-between">
                                                ...
                                                <span className={`text-sm font-medium ${
                                                    userRole === 'Plaintiff' ? 'text-purple-600' : 'text-emerald-600'
                                                }`}>
                                                    {userRole}
                                                </span>
                                            </div>
                                        ...
                                        <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                                            ...
                                            <span className="text-sm font-medium text-gray-600">
                                                {new Date(arbitration.submissionDate).toLocaleDateString()}
                                            </span>
                                        </div>
                                    </div>
                                </div>
