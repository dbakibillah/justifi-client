...
const UserProfile = () => {
  ...
  const [profileData, setProfileData] = useState({
    fullName: "Palash Rahman",
    email: "info@binary-fusion.com",
    phone: "(+62) 821 2554–5846",
    address: "Dhaka, Bangladesh",
    role: "Admin",
    bio: "Passionate about technology and innovation, Palash is an experienced administrator with over 10 years in digital transformation and business development. He loves mentoring young professionals and thrives on creative collaboration.",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl shadow-lg p-6 md:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              ...
              {/* Email */}
              <InfoCard
                icon={<FaEnvelope className="h-5 w-5 text-green-600" />}
                title="Email Address"
              ...
              {/* Phone */}
              <InfoCard
                icon={<FaPhone className="h-5 w-5 text-purple-600" />}
                title="Phone Number"
              ...
              {/* Address */}
              <InfoCard
                icon={<FaMapMarkerAlt className="h-5 w-5 text-orange-600" />}
                title="Address"
...
const InfoCard = ({ icon, title, value, bgColor }) => (
  <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-4 md:p-6 border border-gray-100 hover:border-blue-200 transition-all duration-200">
    ...
    <p className="font-semibold text-gray-800 text-base md:text-lg">{value}</p>
  </div>
);
    ...
    <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8">
      ...
      <div className="space-y-3 md:space-y-4">
        {overviewItems.map((item, index) => (
          <div
            key={index}
            className="flex items-center justify-between py-3 px-4 border border-gray-100 rounded-lg hover:bg-gray-50 hover:border-gray-200 transition-all duration-200 cursor-pointer"
          >
