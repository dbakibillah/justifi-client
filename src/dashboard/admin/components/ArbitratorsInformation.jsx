...
const ArbitratorsInformation = ({ onUpdateArbitrators }) => {
            ...
            <div className="space-y-4">
                <div className="searchable-dropdown relative">
                    ...
                    <input
                        ...
                        onChange={(e) =>
                            handleSearchChange("arbitrator1", e.target.value)
                        }
                    ...
                    {showDropdowns.arbitrator1 && (
                        <div className="dropdown-list absolute top-full left-0 right-0 bg-white border border-gray-300 border-t-0 rounded-b max-h-48 overflow-y-auto z-10">
                            {filteredArbitrators("arbitrator1").map(
                                (arbitrator) => (
                                    <div
                                        key={arbitrator.id}
                ...
                <div className="searchable-dropdown relative">
                    ...
                    <input
                        ...
                        onChange={(e) =>
                            handleSearchChange("arbitrator2", e.target.value)
                        }
                    ...
                    {showDropdowns.arbitrator2 && (
                        <div className="dropdown-list absolute top-full left-0 right-0 bg-white border border-gray-300 border-t-0 rounded-b max-h-48 overflow-y-auto z-10">
                            {filteredArbitrators("arbitrator2").map(
                                (arbitrator) => (
                                    <div
                                        key={arbitrator.id}
                                        className="dropdown-item p-2 cursor-pointer hover:bg-gray-100"
                ...
                <div className="searchable-dropdown relative">
                    ...
                    {showDropdowns.presidingArbitrator && (
                        <div className="dropdown-list absolute top-full left-0 right-0 bg-white border border-gray-300 border-t-0 rounded-b max-h-48 overflow-y-auto z-10">
                            {filteredArbitrators("presidingArbitrator").map(
                                (arbitrator) => (
                                    <div
                                        key={arbitrator.id}
                                        className="dropdown-item p-2 cursor-pointer hover:bg-gray-100"
