...
import MedCaseInfo from "./components/MedCaseInfo";
import MedDefendant from "./components/MedDefendant";
import MedOverview from "./components/MedOverview";
import MedPlaintiff from "./components/MedPlaintiff";
...
const Mediation = () => {
  ...
  const steps = [
    { number: 1, label: "Case Information", mobileLabel: "Case" },
                    ...
                    return (
                      ...
                      >
                        <div className="relative group cursor-pointer">
                          <div
                            className={`w-10 h-10 rounded-xl flex items-center justify-center font-semibold text-sm border-2 transition-all duration-300 ease-out ${
                              isCompleted
                ...
                <div className="flex justify-between">
                  {steps.map((step) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-semibold border-2 transition-all duration-300 relative ${
                            isCompleted
