                            ...
                            >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        ...
                                        />
                                        {errors.plaintiffs?.[plaintiff.id]
                                            ?.name && (
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            type="text"
                                            {...register(
                                                `plaintiffs.${plaintiff.id}.parentsName`
                                            )}
                                            className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200"
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            type="text"
                                            {...register(
                                                `plaintiffs.${plaintiff.id}.address`
                                            )}
                                            className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200"
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            type="text"
                                            {...register(
                                                `plaintiffs.${plaintiff.id}.occupation`
                                            )}
                                            className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200"
