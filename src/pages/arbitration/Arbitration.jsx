...
const Arbitration = () => {
    ...
    const onSubmitPlaintiffs = () => {
        ...
        plaintiffs.forEach((plaintiff) => {
            if (
                currentValues.plaintiffs &&
                currentValues.plaintiffs[plaintiff.id]
            ) {
                plaintiffsData[plaintiff.id] =
                    currentValues.plaintiffs[plaintiff.id];
            }
        });
    ...
    const onSubmitDefendants = () => {
        ...
        defendants.forEach((defendant) => {
            if (
                currentValues.defendants &&
                currentValues.defendants[defendant.id]
            ) {
                defendantsData[defendant.id] =
                    currentValues.defendants[defendant.id];
            }
        });
