...
import { getAllArbitrators } from "../../data/arbitrator";

import ArbitratorCard from "./ArbitratorCard";

export default function Arbitrator() {
  const arbitrator = getAllArbitrators();
  return (
    <div className="">
        ...
        <div className="relative py-3 text-center px-4">
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-center max-w-6xl mx-auto gap-3">
            ...
            <div className="flex border border-[#dfa02b] rounded-md overflow-hidden w-full sm:w-auto">
              <input
                type="text"
                placeholder="Search Your arbitrator"
      ...
      <section className="py-8 px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
          {arbitrator.map((arbitrator) => (
            <ArbitratorCard key={arbitrator.id} arbitrator={arbitrator} />
          ))}
        </div>
      </section>
    </div>
